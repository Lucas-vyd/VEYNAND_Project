...
/**
 * Classe Q1 qui correspont a l'affichage de la réponse à la question 1
 * @author lucas
 * 
 */
...
public class Q1 implements ActionListener{
	...
	JLabel l= new JLabel("Détermination de la liste des articles écrits par un auteur donné.",JLabel.CENTER);
	...
	String var="Réponse à la question 1: \n";
	JTextArea rep = new JTextArea(var);

	/**
	 * action effectué lors du clic sur le JButton "Q1"
	 */
