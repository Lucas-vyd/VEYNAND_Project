...
public class Controleur implements KeyListener {
	...
	/**
	 * commande a retourner la difference avec la commandeencours
	 * vient du fait
	...
	/**
	 * construction du controleur par defaut le controleur n'a pas de
	 * commande
	 */
	public Controleur() {
	...
	/**
	 * quand on demande les commandes, le controleur retourne la
	 * commande en
	 * cours
	 * 
